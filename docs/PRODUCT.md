...
- **Pieces in one set** is explicit product packaging data. QTY remains authoritative; the app derives sale pricing and resulting Stock/set from it when this value is configured.
